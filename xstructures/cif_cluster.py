...
def cif2feffinp(ciftext, absorber, edge=None, cluster_size=8.0,
    ...
    out_text = [f'*** feff input generated by xstructure/cif2feff and pymatgen {isotime()} ***']
