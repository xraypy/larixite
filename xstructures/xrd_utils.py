...
from .physical_constants import PLANCK_HC, TAU, DEG2RAD, RAD2DEG


def wavelength2energy(wavelength, E_units='keV', lambda_units='A'):
    '''
...
def hkl2d(hkl, a, b, c, alpha, beta, gamma, **kws):
    "convert hkl to d"
...
def q2twotheta(q, wavelength, units='degrees'):
    '''
    ...
    '''
    twoth = 2*arcsin((q*wavelength)/(2*TAU))
